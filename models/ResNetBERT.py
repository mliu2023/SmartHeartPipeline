...
class ResNet1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, kernel_size, stride, groups, n_block, n_classes, bert_config = None, vocab_size = 5000, downsample_gap=2, increasefilter_gap=4, num_additional_features=3, use_bn=True, use_do=True, verbose=False):
    ...
    def forward(self, x, demographics):
        ...
        emb = self.embeddings(out)
        out = emb.argmax(dim=2)        
